...
describe('TooltipManager', () => {
    ...
    it('should display correctly formatted values in show()', () => {
        ...
        tooltip.show('zip', '75001', 450000, 'Addison', 'TX', 'Home Value', false);
        ...
        tooltip.show('county', '48001', 0.054, 'Anderson', 'TX', 'Home Value Growth (YoY)', true);
        ...
        tooltip.show('metro', '12345', 45.2, 'Seattle, WA', 'WA', 'Days on Market', false);
